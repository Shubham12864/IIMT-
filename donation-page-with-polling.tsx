...
import { PaymentStatusPoller } from "../lib/payment-status-poller"

export default function UPIDonationPageWithPolling() {
              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-yellow-700">
                    Please complete the payment in the UPI app. We're checking the status automatically...
                  </p>
                </div>
              </div>
            </CardContent>
            ...
            <CardContent className="p-4">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  {paymentData?.id && <p className="text-xs text-green-600 mt-1">Transaction ID: {paymentData.id}</p>}
                </div>
              </div>
            </CardContent>
          </Card>
